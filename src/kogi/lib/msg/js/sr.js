...
Blockly.Msg["MATH_ONLIST_TOOLTIP_AVERAGE"] = "Враћа просек (аритметичка средина) бројчаних вредности са списка.";
...
Blockly.Msg["MATH_ONLIST_TOOLTIP_MODE"] = "Враћа слисак најчешће(их) ставке(и) са списка.";
...
Blockly.Msg["PROCEDURES_CALLNORETURN_TOOLTIP"] = "Покрените кориснички дефинисану функцију „%1”.";
Blockly.Msg["PROCEDURES_CALLRETURN_HELPURL"] = "https://sr.wikipedia.org/wiki/Потпрограм";
Blockly.Msg["PROCEDURES_CALLRETURN_TOOLTIP"] = "Покрените кориснички дефинисану функцију „%1” и користите њен излаз.";
...
Blockly.Msg["PROCEDURES_DEF_DUPLICATE_WARNING"] = "Упозорење: Ова функција има дуплиране параметаре.";
Blockly.Msg["PROCEDURES_HIGHLIGHT_DEF"] = "Истакни дефиницију функције";
Blockly.Msg["PROCEDURES_IFRETURN_HELPURL"] = "http://c2.com/cgi/wiki?GuardClause";  // untranslated
Blockly.Msg["PROCEDURES_IFRETURN_TOOLTIP"] = "Ако је вредност „тачно“, онда врати другу вредност.";
Blockly.Msg["PROCEDURES_IFRETURN_WARNING"] = "Упозорење: Овај блок се може користити једино унутар дефиниције функције.";
Blockly.Msg["PROCEDURES_MUTATORARG_TITLE"] = "име уноса:";
...
Blockly.Msg["TEXT_APPEND_TOOLTIP"] = "Додаје текст на променљиву „%1“.";
